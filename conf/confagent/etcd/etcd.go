...
func InitOnce(porjname string) {
	...
	str := `[{
		"name":"Douyin",
		"port":8001,"version":"v0.0.1",
		"start_time":"2023-07-30",
		"machine_id":1,
		"logconfig":{
			"path":"./logger/douyin.log",
			"topic":"douyinlog",
			"max_size":200,
			"max_backups":7,
			"max_age":30,
		...
		"service":{
			...
			"message_service_url":"127.0.0.1:9007",
			"comment_service_name":"comment",
			"comment_service_url":"127.0.0.1:9005",
			"relation_service_name":"relation",
			"relation_service_url":"127.0.0.1:9004",
			"publish_service_name":"publish",
			"publish_service_url":"127.0.0.1:9008"
		},
		"video":{"feedcount":30},
		"ratelimit":{"rate":2,"cap":10},
		"esconfig":{
